...
|---|---|---|---|---|---|
| native Go | 37,968 | 0 | 0 | 1× | 컴파일 |
| wazero | 62,219 | 16 | 2 | 1.6× | WASM JIT |
| **minivm** | **1,157,136** | **0** | **0** | **30×** | **스레디드 인터프리터** |
| tengo | 2,000,364 | 319,474 | 28,657 | 53× | 바이트코드 VM |
| gopher-lua | 2,942,015 | 703 | 2 | 77× | 레지스터 VM |
| goja | 3,964,702 | 3,643 | 39 | 104× | 바이트코드 VM |
