...
func TestNew(t *testing.T) {
		...
		},
		{
			...
			want: slices.Concat(
				...
				[]asm.Instruction{
					...
					asmarm64.LDR(vreg(13), vreg(10), int16(journal.CellDepth*8)),
					asmarm64.LSLI(vreg(14), vreg(13), journal.Shift),
					asmarm64.ADD(vreg(15), vreg(10), vreg(14)),
					asmarm64.MOVZ(vreg(16), 1, 0),
					asmarm64.STP(vreg(16), vreg(11), vreg(15), int16(journal.At(0, journal.RecordAddr)*8)),
					asmarm64.MOVZ(vreg(17), 0, 0),
					asmarm64.MOVZ(vreg(18), 1, 0),
					asmarm64.STP(vreg(17), vreg(18), vreg(15), int16(journal.At(0, journal.RecordIP)*8)),
					asmarm64.ADDI(vreg(13), vreg(13), 1),
					asmarm64.STR(vreg(13), vreg(10), int16(journal.CellDepth*8)),
					asmarm64.MOVZ(vreg(19), 1, 0),
					asmarm64.STR(vreg(19), vreg(10), int16(journal.CellExitID*8)),
					asmarm64.MOVZ(vreg(20), uint16(journal.TrapFallback), 0),
					asmarm64.STR(vreg(20), vreg(10), int16(journal.CellTrap*8)),
					asmarm64.MOVZ(vreg(21), 0, 0),
					asmarm64.STR(vreg(21), vreg(10), int16(journal.CellNextIP*8)),
					asmarm64.RET(),
				},
			),
		},
		...
		},
		{
			...
			want: slices.Concat(
				...
				[]asm.Instruction{
					...
					asmarm64.LDR(vreg(16), vreg(13), int16(journal.CellDepth*8)),
					asmarm64.LSLI(vreg(17), vreg(16), journal.Shift),
					asmarm64.ADD(vreg(18), vreg(13), vreg(17)),
					asmarm64.MOVZ(vreg(19), 0, 0),
					asmarm64.STP(vreg(19), vreg(14), vreg(18), int16(journal.At(0, journal.RecordAddr)*8)),
					asmarm64.MOVZ(vreg(20), 1, 0),
					asmarm64.MOVZ(vreg(21), 0, 0),
					asmarm64.STP(vreg(20), vreg(21), vreg(18), int16(journal.At(0, journal.RecordIP)*8)),
					asmarm64.ADDI(vreg(16), vreg(16), 1),
					asmarm64.STR(vreg(16), vreg(13), int16(journal.CellDepth*8)),
					asmarm64.MOVZ(vreg(22), 1, 0),
					asmarm64.STR(vreg(22), vreg(13), int16(journal.CellExitID*8)),
					asmarm64.MOVZ(vreg(23), uint16(journal.TrapFallback), 0),
					asmarm64.STR(vreg(23), vreg(13), int16(journal.CellTrap*8)),
					asmarm64.MOVZ(vreg(24), 1, 0),
					asmarm64.STR(vreg(24), vreg(13), int16(journal.CellNextIP*8)),
					asmarm64.RET(),
				},
			),
		},
		{
			...
			want: slices.Concat(
				...
				[]asm.Instruction{
					...
					asmarm64.LDR(vreg(22), vreg(19), int16(journal.CellDepth*8)),
					asmarm64.LSLI(vreg(23), vreg(22), journal.Shift),
					asmarm64.ADD(vreg(24), vreg(19), vreg(23)),
					asmarm64.MOVZ(vreg(25), 0, 0),
					asmarm64.STP(vreg(25), vreg(20), vreg(24), int16(journal.At(0, journal.RecordAddr)*8)),
					asmarm64.MOVZ(vreg(26), 3, 0),
					asmarm64.MOVZ(vreg(27), 0, 0),
					asmarm64.STP(vreg(26), vreg(27), vreg(24), int16(journal.At(0, journal.RecordIP)*8)),
					asmarm64.ADDI(vreg(22), vreg(22), 1),
					asmarm64.STR(vreg(22), vreg(19), int16(journal.CellDepth*8)),
					asmarm64.MOVZ(vreg(28), 1, 0),
					asmarm64.STR(vreg(28), vreg(19), int16(journal.CellExitID*8)),
					asmarm64.MOVZ(vreg(29), uint16(journal.TrapFallback), 0),
					asmarm64.STR(vreg(29), vreg(19), int16(journal.CellTrap*8)),
					asmarm64.MOVZ(vreg(30), 3, 0),
					asmarm64.STR(vreg(30), vreg(19), int16(journal.CellNextIP*8)),
					asmarm64.RET(),
				},
			),
		},
		...
		},
		{
			...
			want: func() []asm.Instruction {
				...
				return slices.Concat(
					...
					stub(44, 2, 5, structGetIP, 0, 2),
					stub(60, 3, 6, structGetIP, 0, 2),
				)
			}(),
		},
		{
			...
			want: slices.Concat(
				...
				stub(42, 2, 5, arrayGetIP, 8, 3),
				stub(58, 3, 6, arrayGetIP, 8, 3),
			),
		},
		{
			...
			want: func() []asm.Instruction {
				...
				return slices.Concat(
					...
					stub(46, 2, 6, structGetIP, 0, 2),
					stub(62, 3, 7, structGetIP, 0, 2),
					stub(78, 4, 8, structGetIP, 0, 2),
				)
			}(),
		},
		{
	...
	t.Run("reads a *HostStruct field through the shape and Go kind that admitted it", func(t *testing.T) {
		...
		want := slices.Concat(
			...
			stub(45, 2, 5, structGetIP, 0, 2),
			stub(61, 3, 6, structGetIP, 0, 2),
		)
	...
	t.Run("reads an in-range i64 *HostStruct field, guarding the boxed payload", func(t *testing.T) {
		...
		want := slices.Concat(
			...
			stub(47, 2, 6, structGetIP, 0, 2),
			stub(63, 3, 7, structGetIP, 0, 2),
			stub(79, 4, 8, structGetIP, 0, 2),
		)
		require.Equal(t, want, assembler.Instructions())
