...
func TestEncoder_Encode(t *testing.T) {
	...
	goldens := []struct {
		...
		{"SXTB X1,X2", arm64.SXTB(arm64.X1, arm64.X2), 0x93401C41},
		{"SXTB W1,W2", arm64.SXTB(arm64.W1, arm64.W2), 0x13001C41},
		{"SXTH X1,X2", arm64.SXTH(arm64.X1, arm64.X2), 0x93403C41},
		{"SXTH W1,W2", arm64.SXTH(arm64.W1, arm64.W2), 0x13003C41},
		{"SXTW X1,X2", arm64.SXTW(arm64.X1, arm64.X2), 0x93407C41},
		{"UXTB X1,X2", arm64.UXTB(arm64.X1, arm64.X2), 0xD3401C41},
		{"UXTB W1,W2", arm64.UXTB(arm64.W1, arm64.W2), 0x53001C41},
		{"UXTH X1,X2", arm64.UXTH(arm64.X1, arm64.X2), 0xD3403C41},
		{"UXTH W1,W2", arm64.UXTH(arm64.W1, arm64.W2), 0x53003C41},
		{"UXTW X1,X2", arm64.UXTW(arm64.X1, arm64.X2), 0xD3407C41},
		...
		{"LDRSB W1,[X2,#1]", arm64.LDRSB(arm64.W1, arm64.X2, 1), 0x39C00441},
		{"LDRH X1,[X2,#2]", arm64.LDRH(arm64.X1, arm64.X2, 2), 0x79400441},
		{"LDRSH X1,[X2,#2]", arm64.LDRSH(arm64.X1, arm64.X2, 2), 0x79800441},
		{"LDRSH W1,[X2,#2]", arm64.LDRSH(arm64.W1, arm64.X2, 2), 0x79C00441},
