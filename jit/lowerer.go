...
type Context struct {
	...
	// a function ref for the immediately-following CALL). The driver does
	// not read it. -1 means "no carry". Lowerers are responsible for
	// resetting it at appropriate dispatch boundaries.
	Target int
