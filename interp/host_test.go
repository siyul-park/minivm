...
func TestHostObject(t *testing.T) {
	...
	t.Run("unsafe field access covers scalar and value fields", func(t *testing.T) {
		...
		ho.SetField(hostFieldIndex(t, ho, "I8"), types.BoxI32(18))
		ho.SetField(hostFieldIndex(t, ho, "I16"), types.BoxI32(19))
		ho.SetField(hostFieldIndex(t, ho, "I32"), types.BoxI32(20))
		ho.SetField(hostFieldIndex(t, ho, "I"), types.BoxI64(21))
		ho.SetField(hostFieldIndex(t, ho, "I64"), types.BoxI64(22))
		ho.SetField(hostFieldIndex(t, ho, "U8"), types.BoxI32(21))
		ho.SetField(hostFieldIndex(t, ho, "U16"), types.BoxI32(22))
		ho.SetField(hostFieldIndex(t, ho, "U32"), types.BoxI32(23))
		ho.SetField(hostFieldIndex(t, ho, "U"), types.BoxI64(24))
		ho.SetField(hostFieldIndex(t, ho, "U64"), types.BoxI64(25))
		ho.SetField(hostFieldIndex(t, ho, "Uintpt"), types.BoxI64(26))
		ho.SetField(hostFieldIndex(t, ho, "F32"), types.BoxF32(3.5))
		ho.SetField(hostFieldIndex(t, ho, "F64"), types.BoxF64(4.5))
		require.Equal(t, uint64(21), ho.Raw(hostFieldIndex(t, ho, "I")))
		require.Equal(t, uint64(24), ho.Raw(hostFieldIndex(t, ho, "U")))
		ho.SetRaw(hostFieldIndex(t, ho, "I"), 88)
		ho.SetRaw(hostFieldIndex(t, ho, "I64"), 99)
		ho.SetRaw(hostFieldIndex(t, ho, "U"), 100)
		ho.SetRaw(hostFieldIndex(t, ho, "U64"), 101)
		ho.SetRaw(hostFieldIndex(t, ho, "Uintpt"), 102)
