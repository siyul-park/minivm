...
func i64SlotFunction() *ssa.Function {
	...
	b.Add(entry, ssa.Operation{Op: ssa.OpConst, Const: types.BoxI64(1234), Results: []ssa.Value{basis}})
	state := b.Value(ssa.TypeState)
	b.Add(entry, ssa.Operation{Op: ssa.OpState, Frames: []ssa.Frame{{Address: 1, IP: 1}}, Results: []ssa.Value{state}})
	...
	b.Add(header, ssa.Operation{Op: ssa.OpConst, Const: types.BoxI64(10), Results: []ssa.Value{bound}})
	cond := b.Value(ssa.TypeI1)
	...
	b.Add(body, ssa.Operation{Op: ssa.OpConst, Const: types.BoxI64(1), Results: []ssa.Value{one}})
