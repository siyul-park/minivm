...
func TestPromotePass_Run(t *testing.T) {
	...
	t.Run("gives an entry that is its own loop header a block to load in", func(t *testing.T) {
		...
		b.Add(header, ssa.Operation{Op: ssa.OpExec, Code: instr.I32_ADD, Args: []ssa.Value{held, one}, State: deoptState(b, header, instr.I32_ADD), Results: []ssa.Value{next}})
		...
		b.Add(header, ssa.Operation{Op: ssa.OpExec, Code: instr.I32_EQZ, Args: []ssa.Value{next}, State: deoptState(b, header, instr.I32_EQZ), Results: []ssa.Value{cond}})
...
func slotLoop() *ssa.Function {
	...
	cond := b.Value(ssa.TypeI1)
	b.Add(header, ssa.Operation{Op: ssa.OpExec, Code: instr.I32_LT_S, Args: []ssa.Value{held, bound}, State: deoptState(b, entry, instr.I32_LT_S), Results: []ssa.Value{cond}})
