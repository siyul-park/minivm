	...
	tests := []struct {
		...
		},
		{
			...
			expected: program.New(
				...
				program.WithConstants(types.I1(false)),
			),
		},
		{
			program: program.New(
			...
			expected: program.New(
				...
				program.WithConstants(types.I1(true)),
			),
		},
		{
			program: program.New(
		...
		},
		{
			...
			expected: program.New(
				...
				program.WithConstants(types.String("foo"), types.I1(true)),
			),
		},
		{
			program: program.New(
			...
			expected: program.New(
				...
				program.WithConstants(types.String("foo"), types.I1(false)),
			),
		},
		{
			program: program.New(
			...
			expected: program.New(
				...
				program.WithConstants(types.String("foo"), types.String("bar"), types.I1(false)),
			),
		},
		{
			program: program.New(
			...
			expected: program.New(
				...
				program.WithConstants(types.String("foo"), types.String("bar"), types.I1(true)),
			),
		},
		{
			program: program.New(
