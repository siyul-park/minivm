...
var dispatch = [256]func(vm *VM) error{
	...
	instr.I32_LOAD: func(vm *VM) error {
		...
		vm.stack[vm.sp] = types.BoxI32(int32(val))
		vm.frames[vm.fp].ip++
		return nil
	},
	...
	instr.I32_SUB: func(vm *VM) error {
		...
		vm.sp--
		vm.stack[vm.sp] = types.BoxI32(v2 - v1)
		vm.frames[vm.fp].ip++
		return nil
	},
	...
	instr.I32_DIV_U: func(vm *VM) error {
		...
		vm.sp--
		vm.stack[vm.sp] = types.BoxI32(int32(uint32(v2) / uint32(v1)))
		vm.frames[vm.fp].ip++
		return nil
	},
	...
	instr.I32_EQ: func(vm *VM) error {
		...
		vm.sp--
		vm.stack[vm.sp] = types.BoxI32(int32(types.Bool(v2 == v1)))
		vm.frames[vm.fp].ip++
		return nil
	},
	...
	instr.I32_LT_U: func(vm *VM) error {
		...
		vm.sp--
		vm.stack[vm.sp] = types.BoxI32(int32(types.Bool(uint32(v2) < uint32(v1))))
		vm.frames[vm.fp].ip++
		return nil
	},
	...
	instr.I64_CONST: func(vm *VM) error {
		...
		v := int64(binary.BigEndian.Uint64(code[frame.ip+1:]))

		var val types.Boxed
		if types.IsBoxable(v) {
			val = types.BoxI64(v)
		} else {
	...
	instr.I64_LOAD: func(vm *VM) error {
		...
		if types.IsBoxable(int64(val)) {
			...
			vm.stack[vm.sp] = types.BoxI64(int64(val))
		}
	...
	instr.I64_ADD: func(vm *VM) error {
		...
		v1, err := vm.unboxI64(vm.stack[vm.sp])
		if err != nil {
			return err
		}
		v2, err := vm.unboxI64(vm.stack[vm.sp-1])
		if err != nil {
			return err
		}
	...
	instr.I64_LT_U: func(vm *VM) error {
		...
		vm.sp--
		vm.stack[vm.sp] = types.BoxI32(int32(types.Bool(uint64(v2) < uint64(v1))))
		vm.frames[vm.fp].ip++
		return nil
	},
	...
	instr.F32_LOAD: func(vm *VM) error {
		...
		vm.stack[vm.sp] = types.BoxF32(float32(val))
		vm.frames[vm.fp].ip++
		return nil
	},
	...
	instr.F32_ADD: func(vm *VM) error {
		...
		v1 := vm.stack[vm.sp].F32()
		v2 := vm.stack[vm.sp-1].F32()

		vm.sp--
		vm.stack[vm.sp] = types.BoxF32(v1 + v2)
		vm.frames[vm.fp].ip++
		return nil
	},
	instr.F32_SUB: func(vm *VM) error {
		...
		vm.sp--
		vm.stack[vm.sp] = types.BoxF32(v2 - v1)
		vm.frames[vm.fp].ip++
		return nil
	},
	...
	instr.F64_LOAD: func(vm *VM) error {
		...
		vm.stack[vm.sp] = types.BoxF64(float64(val))
		vm.frames[vm.fp].ip++
		return nil
	},
	...
	instr.F64_ADD: func(vm *VM) error {
		...
		v1 := vm.stack[vm.sp].F64()
		v2 := vm.stack[vm.sp-1].F64()

		vm.sp--
		vm.stack[vm.sp] = types.BoxF64(v1 + v2)
		vm.frames[vm.fp].ip++
		return nil
	},
	instr.F64_SUB: func(vm *VM) error {
		...
		vm.sp--
		vm.stack[vm.sp] = types.BoxF64(v2 - v1)
		vm.frames[vm.fp].ip++
		return nil
	},
