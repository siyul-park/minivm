...
| `BR_TABLE` | `{-2, 2}` | `index →` | ◐ | Jump table; negative or out-of-range index uses default target. Trace JIT lowers the observed target and learned side-exit targets for simple stack shapes. |
