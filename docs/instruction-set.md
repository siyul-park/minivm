...
| References | `REF_IS_NULL` | `ref.is_null` | ⬜ | 🔲 | bridges to threaded on ARM64 |
...
| Arrays | `ARRAY_LEN` | `array.len` | ⬜ | 🔲 | bridges to threaded on ARM64 |
| Arrays | `ARRAY_GET` | `array.get` | ⬜ | 🔲 | bridges to threaded on ARM64 |
| Arrays | `ARRAY_SET` | `array.set` | ⬜ | 🔲 | bridges to threaded on ARM64 |
...
| Structs | `STRUCT_GET` | `struct.get` | ⬜ | 🔲 | bridges to threaded on ARM64 |
| Structs | `STRUCT_SET` | `struct.set` | ⬜ | 🔲 | bridges to threaded on ARM64 |
