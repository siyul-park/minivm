...
| Concern | File |
|---|---|
| Opcode lowering | `internal/cmd/genfusion/opcodes.go` |
| Fusion declarations and expansion | `internal/cmd/genfusion/rules.go` |
| Generation and file assembly | `internal/cmd/genfusion/render.go` |
| Rule validation | `internal/cmd/genfusion/validate.go` |
...
The generator validates the concrete rules declared in `internal/cmd/genfusion/rules.go`.
